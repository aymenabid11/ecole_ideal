    ...
    <div class="container">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#menu"><img src="images/Logo/lg.png" alt=""></a> </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <ul class="nav navbar-nav">
            <li><a class="scroll" >Contact</a></li>
          </ul>
        </div>
        <!-- /.navbar-collapse -->
      </div>
        ...
        <div class="carousel-caption container">
          <div class="row">
            <div class="col-md-7 col-sm-12 col-xs-12">
              ...
              <p>une formation integreé de 10 mois qui comprend un encadrement theorique et pratique complet avec un diplome reconnu le niveau nationnal et le niveau mondial</p>
            </div>
          </div>
        </div>
      </div>
...
<section id="pricing">
  <div class="container">
    <div class="col-md-8 col-md-offset-2">
      <div class="heading">
        <h2>PRIX forma<span>tion</span></h2>
        <div class="line"></div>
        <p><span><strong>L</strong></span>orem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut 
          et dolore magna aliqua. Ut enim ad minim veniam</p>
      </div>
          ...
          <ul class="pricing">
            <li class="plan-header">
              <div class="price-duration">
                <div class="price"> 1000 DT </div>
                <div class="duration"> Anneé </div>
              </div>
              <div class="plan-name"> Coiffure homme </div>
            </li>
            <li><strong>1</strong> Personne</li>
            <li><strong>100 DT</strong> Par mois </li>
            <li>Autre payement</li>
            <li><strong>150 DT</strong> Frais examen</li>
            <li><strong>90 DT</strong> Frais Inscription</li>            
            <li><a class="btn-order" href="#">Inscrire</a> </li>
          </ul>
        </div>
      </div>
      <div class="col-sm-6 col-md-3">
