                ...
                <div class="d-none d-lg-block col-lg-4">
                    ...
                    <div class="h-100 d-flex bg-white justify-content-center align-items-center col-md-12 col-lg-8">
                        <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                            ...
                            <h4 class="mb-0">
                                <span class="d-block">Mot de passe oublié?</span>
                                <span>Aucun problème. Indiquez-nous simplement votre adresse e-mail et nous vous enverrons par e-mail un lien de réinitialisation de mot de passe qui vous permettra d'en choisir un nouveau.</span>
                            </h4>
                                ...
                                <div class="form-row">
                                    <div class="col-md-12">
                                        <div class="position-relative form-group">
                                            ...
                                            <input name="email" id="email" placeholder="Email here..." type="email"  required autofocus class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-4 d-flex align-items-center">
                                        <h6 class="mb-0">
                                            <a href="{{ route('login') }}" class="text-primary">Connectez</a>
                                        </h6>
                                        <div class="ml-auto">
                                            <button class="btn btn-primary btn-lg">réinitialiser le mot de passe</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
